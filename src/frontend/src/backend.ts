...
export class Backend implements backendInterface {
    ...
    async clearAllCalculations(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllCalculations();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteCalculation(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCalculation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCalculations(): Promise<Array<GasMixture>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCalculations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCalculation(arg0: string, arg1: string, arg2: bigint, arg3: bigint, arg4: bigint, arg5: bigint, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCalculation(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
